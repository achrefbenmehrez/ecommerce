                ...
                <div class="ps-section__header mb-50">
                    ...
                    <ul class="ps-masonry__filter">
                        ...
                        @foreach ($categories as $category)
                            <li><a href="#" data-filter=".{{ $category->slug }}">{{ $category->name }}
                                    <sup>{{ count($category->products) }}</sup></a></li>
                        @endforeach
                    </ul>
                </div>
                                    ...
                                    <div class="grid-item__content-wrapper">
                                        <div class="ps-shoe mb-30">
                                            <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                                                    ...
                                                    src="{{ asset($product->photosUrl[0]) }}" alt=""><a
                                                    class="ps-shoe__overlay" href="{{ route('products.show', $product->id) }}"></a>
                                            </div>
                                            <div class="ps-shoe__content">
                                                ...
                                                <div class="ps-shoe__detail"><a class="ps-shoe__name"
                                                    ...
                                                    <p class="ps-shoe__categories"><a
                                                            href="#">{{ $product->category->name }}</a></p><span
                                                        class="ps-shoe__price">
                                                        {{ $product->price }} DNT</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="ps-shoe">
                                    <div class="ps-shoe__thumbnail">
                                        <a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img
                                            src="{{ asset($product->photosUrl[0]) }}" alt=""><a class="ps-shoe__overlay"
                                    ...
                                    <div class="ps-shoe__content">
                                        ...
                                        <div class="ps-shoe__detail"><a class="ps-shoe__name"
                                                href="product-detai.html">{{ $product->name }}</a>
                                            <p class="ps-shoe__categories"><a href="#">{{ $product->category->name }}</a>
                                            </p><span class="ps-shoe__price">{{ $product->price }} DNT</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
