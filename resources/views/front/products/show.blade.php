            ...
            <div class="row">
                <div class="col-lg-10 col-md-12 col-lg-offset-1">
                        ...
                        <div class="ps-product__preview">
                            <div class="ps-product__variants">
                                @foreach ($product->photosUrl as $photo)
                                    <div class="item"><img src="{{ asset($photo) }}" alt=""></div>
                                @endforeach
                            </div>
                        </div>
                        <div class="ps-product__image">
                            @foreach ($product->photosUrl as $photo)
                            <div class="item"><img class="zoom" height="395px" width="395px" src="{{ asset($photo) }}" alt=""
                                data-zoom-image="{{ $photo }}"></div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="ps-product__info">
                        ...
                        <h3 class="ps-product__price">{{ $product->price }} DNT</h3>
